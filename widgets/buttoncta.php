...
?>
    ...
    function widget( $args, $instance ) {
        ...
        if(isset($instance['select_target'])) $select_target = $instance['select_target']; else $select_target = '';
        ...
        echo $before_widget; ?>
            ...
            <div class="ctabutton">
                <a class="button<?php if ( !empty( $buttonstyle ) ) { echo " ".$buttonstyle;  } ?>" href="<?php echo $buttonurl; ?>" <?php if($select_target) echo ' target="'.$select_target.'"';?>><?php echo $buttontext; ?></a>
            </div>
        <?php
        echo $after_widget;
    }
