( function( blocks, i18n, element, _ ) {
	...
	blocks.registerBlockType( 'widgen/contact-info', {
		title: i18n.__( 'Contact Info' ),
			...
			return (
				el( 'div', { className: props.className },
					el( blocks.Editable, {
						tagName: 'h2',
						inline: true,
						placeholder: i18n.__( 'Company title' ),
					...
					el( blocks.Editable, {
						tagName: 'p',
						inline: true,
						placeholder: i18n.__( 'Address' ),
						value: attributes.title,
						onChange: function( value ) {
							props.setAttributes( { title: value } );
						},
						focus: focusedEditable === 'address' ? focus : null,
						onFocus: function( focus ) {
							props.setFocus( _.extend( {}, focus, { editable: 'address' } ) );
						},
					} ),
					...
					el( 'h3', { className: 'entry-title'}, i18n.__( 'Ingredients' ) ),
					el( blocks.Editable, {
						tagName: 'ul',
						multiline: 'li',
